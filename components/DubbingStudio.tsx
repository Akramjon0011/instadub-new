...
const DubbingStudio: React.FC<DubbingStudioProps> = ({ videoFile, result, onReset }) => {
  ...
  const playDubbed = useCallback(async () => {
    ...
    // Some browsers reset playbackRate on play().
    videoRef.current.playbackRate = playbackRate;
    ...
    videoRef.current.onended = () => {
       // If video ends before audio (shouldn't happen with correct sync), we just wait for audio.
       // If video was faster, it stops on last frame.
    };

  }, [result.audioBuffer, stopAudio, bgVolume, audioSpeed, getSyncFactor]);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-700">
          ...
          <div className="flex flex-col gap-3 mt-4">
             ...
             <div className="flex items-center justify-between bg-gray-900/50 p-3 rounded-lg border border-gray-600">
                <span className="text-sm text-gray-300 font-medium">Videoni Ovozga Moslash</span>
                <button 
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-gray-800 rounded-xl p-4 shadow-lg border border-blue-500 flex-1 relative overflow-hidden flex flex-col">
            <div className="absolute top-0 right-0 p-2 bg-blue-600 text-xs font-bold rounded-bl-lg">O'zbekcha</div>
